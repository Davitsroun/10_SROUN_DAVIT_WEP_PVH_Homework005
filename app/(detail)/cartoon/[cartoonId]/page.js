import { CartoonByid } from "@/service/CartoonByid";
    ...
    return(
        ...
        <div className="w-full h-screen bg-gray-200  overflow-auto ">
                <div className="w-[80%] h-screen  mx-auto flex flex-col relative ">
                    ...
                    <img
                    src= { getcartoon.payload.image }
                     className="w-[250px] h-[350px] bg-gray-50 absolute right-[90px]  rounded-3xl top-[8%]" >
                       </img>

                    <div className="w-full h-[20%] pt-10 flex flex-row gap-5 font-medium self-center   text-text-100  ">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.79 22.75H6.21C3.47 22.75 1.25 20.52 1.25 17.78V10.37C1.25 9.00997 2.09 7.29997 3.17 6.45997L8.56 2.25997C10.18 0.999974 12.77 0.939974 14.45 2.11997L20.63 6.44997C21.82 7.27997 22.75 9.05997 22.75 10.51V17.79C22.75 20.52 20.53 22.75 17.79 22.75ZM9.48 
                            3.43997L4.09 7.63997C3.38 8.19997 2.75 9.46997 2.75 10.37V17.78C2.75 19.69 4.3 21.25 6.21 21.25H17.79C19.7 21.25 21.25 19.7 21.25 17.79V10.51C21.25 9.54997 20.56 8.21997 19.77 7.67997L13.59 3.34997C12.45 2.54997 10.57 2.58997 9.48 3.43997Z" fill="#0B3954" />
                        ...
                        <svg className="mt-1 " width="9" height="18" viewBox="0 0 9 18" fill="blue" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.91 17.67C0.72 17.67 0.53 17.6 0.38 17.45C0.0900004 17.16 0.0900004 16.68 0.38 16.39L6.9 9.87002C7.38
                             9.39002 7.38 8.61002 6.9 8.13002L0.38 1.61002C0.0900004 1.32002 0.0900004 0.84002 0.38 0.55002C0.67 0.26002 1.15 0.26002 1.44 0.55002L7.96 7.07002C8.47 7.58002 8.76 8.27002 8.76 9.00002C8.76 9.73002 8.48 10.42 7.96 10.93L1.44 17.45C1.29 17.59 1.1 17.67 0.91 17.67Z" fill="#0B3954" />
                        </svg>
                    ...
                    <div className="w-full h-[80%] bg-white rounded-3xl pt-[10%] pl-[5%] pr-[5%] overflow-auto">
                        ...
                        <p className="font-medium text-2xl mb-5">{getcartoon.payload.ct_title}</p>
                        <p className="font-medium text-2xl mb-3">   by <span className="font-medium text-2xl text-text-100">{getcartoon.payload.ct_creator}</span></p>
                        <p className="text-gray-500 leading-8">{getcartoon.payload. ct_description }</p>
                    </div>
